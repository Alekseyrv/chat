...
// как это работает: у каждомго элемента массива есть первоначальный элемент - этот элемент является темой объединящей остальные элементы в конкретном массиве, например анализы общий тэг для анализы, где находится раздел анализов и т.д.
