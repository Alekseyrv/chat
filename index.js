...
// как это работает: у каждого элемента массива есть первоначальный элемент - этот элемент является темой объединящей остальные элементы в конкретном массиве, например анализы общий тэг для набора синонимов 'анализы', 'где находится раздел анализов' и т.д.
// каждый синоним (элемент массива) проверяется на степень совпадния векторов со введенным пользовтаелем словом.
